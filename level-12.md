...
The first set of characters was:

"a-zA-Z"

This represented all lowercase letters followed by all uppercase letters.

The second set needed to contain the corresponding replacement characters. For lowercase letters, "a-z" needed to be replaced by "n-z" followed by "a-m", producing:

"n-za-m"

The same rotation was then applied to the uppercase letters, producing:

"N-ZA-M"

The complete command was therefore constructed as:

"cat data.txt | tr 'a-zA-Z' 'n-za-mN-ZA-M'"

"cat data.txt" passed the contents of the file through the pipeline. "tr" then replaced each character from the first set with the corresponding character from the second set. This reversed the 13-position rotation and displayed the password.
